...
namespace TaskLayer
{
    ...
    public abstract class MetaMorpheusTask
    {
        ...
        public static CommonParameters SetAllFileSpecificCommonParams(CommonParameters commonParams, FileSpecificParameters fileSpecificParams)
        {
            ...
            int maxPeptideLength = fileSpecificParams.MaxLength ?? commonParams.DigestionParams.MaxLength;
            int maxMissedCleavages = fileSpecificParams.MaxMissedCleavages ?? commonParams.DigestionParams.MaxMissedCleavages;
            int maxModsForPeptide = fileSpecificParams.MaxMods ?? commonParams.DigestionParams.MaxMods;
        ...
        protected List<Protein> LoadProteins(string taskId, List<DbForTask> dbFilenameList, bool searchTarget, DecoyType decoyType, 
            List<string> localizeableModificationTypes, CommonParameters commonParameters)
        {
        ...
        protected static List<Protein> LoadProteinDb(string fileName, bool generateTargets, DecoyType decoyType, List<string> localizeableModificationTypes,
            bool isContaminant, out Dictionary<string, Modification> um,
        ...
        protected void LoadModifications(string taskId, out List<Modification> variableModifications, out List<Modification> fixedModifications, 
        ...
        protected static void WriteOsmsToTsv(IEnumerable<OligoSpectralMatch> osms, string filePath,
            IReadOnlyDictionary<string, int> modstoWritePruned)
        {
            OligoSpectralMatch.Export(osms.ToList(), filePath);
        }
