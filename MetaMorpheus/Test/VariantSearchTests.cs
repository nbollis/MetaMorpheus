...
namespace Test
{
    ...
    internal class VariantSearchTests
    {
        ...
        public static void SearchTests(int proteinIdx, int peptideIdx, bool containsVariant, string variantPsmShort, DecoyType decoyType = DecoyType.None)
        {
            ...
            IPrecursor pep = proteins[proteinIdx].GetVariantProteins().SelectMany(p => p.Digest(CommonParameters.DigestionParams, null, null)).ToList()[peptideIdx];
            ...
            MsDataFile myMsDataFile = new TestDataFile(new List<IPrecursor> { pep });
        ...
        public void MoreTests(string filename, DecoyType decoyType = DecoyType.None)
        {
            ...
            IPrecursor pep = peps[peps.Count - 2];
