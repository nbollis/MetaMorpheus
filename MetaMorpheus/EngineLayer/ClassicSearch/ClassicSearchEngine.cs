    ...
    public class ClassicSearchEngine : MetaMorpheusEngine
    {
        ...
        private void AddPeptideCandidateToPsm(ScanWithIndexAndNotchInfo scan, double thisScore, IBioPolymerWithSetMods peptide, List<MatchedFragmentIon> matchedIons)
        {
            ...
            lock (Locks[scan.ScanIndex])
            {
                ...
                {
                    PeptideSpectralMatches[scan.ScanIndex] = new PeptideSpectralMatch(peptide, scan.Notch, thisScore, scan.ScanIndex, ArrayOfSortedMS2Scans[scan.ScanIndex], CommonParameters, matchedIons, LogType);
                }
                else
                {
