...
namespace Test
{
    public static  class AARemoveThis
    {
        ...
        public static void GetScansfromPrecursor1()
        {
            ...
            var foldersFor28 = searchFolders.Where(p => p.Contains("Sample28")).ToList();
            ...
            foreach (var folder in foldersFor28)
            {
                ...
                var startIndex = manuscriptProse.IndexOf("Spectra files: ") + 1;
                var endIndex = manuscriptProse.IndexOf("Databases:");
            ...
            PSMInfo.OutputAsTsv(directoryPath, "Sample28_FirstMs1PsmIds", psminfo);
        }
    }
