...
namespace TaskLayer
{
    public class MyFileManager
    {
        ...
        {
            FilteringParams filter = new FilteringParams(commonParameters.NumberOfPeaksToKeepPerWindow,
                commonParameters.MinimumAllowedIntensityRatioToBasePeak, commonParameters.WindowWidthThomsons,
                commonParameters.NumberOfWindows, commonParameters.NormalizePeaksAccrossAllWindows,
        ...
        public MsDataFile OpenDynamicDataConnection(string origDataFile)
        {
            var file = MsDataFileReader.GetDataFile(origDataFile);
