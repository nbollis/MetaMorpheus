...
public class CachedBioPolymer : IBioPolymer
{
    ...
    public IBioPolymer CloneWithNewSequenceAndMods(string newBaseSequence, IDictionary<int, List<Modification>>? newMods) => _bioPolymer.CloneWithNewSequenceAndMods(newBaseSequence, newMods);
