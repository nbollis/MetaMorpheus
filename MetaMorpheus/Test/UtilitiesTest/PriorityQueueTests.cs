...
public class PriorityQueueWithSimpleTypesTests
{
    ...
    public void GetEnumerator_ShouldEnumerateItemsInPriorityOrder()
    {
        ...
        Assert.That(items, Is.EqualTo(new List<string> { "item3", "item2", "item1" }));
    }
    ...
    public void Enumerator_ShouldEnumerateItemsInPriorityOrder_WithDuplicatePriorities()
    {
        ...
        pq.Enqueue(2, "item3");
        var items = new List<string>(pq);
        Assert.That(items, Is.EqualTo(new List<string> { "item2", "item3", "item1" }));
    }
    ...
    public void Constructor_ShouldSetMaxCapacity()
    {
        ...
        var items = new List<string>(pq);
        Assert.That(items, Is.EqualTo(new List<string> { "item9", "item8", "item7", "item6", "item5" }));
    }
    ...
    public void ToList_ShouldReturnListOfItems_SmallNumberOfValues()
    {
        ...
        Assert.That(list, Is.EqualTo(new string[] { "item3", "item2", "item1" }));
    }

    [Test]
    public void ToList_ShouldReturnListOfItems_LargeNumberOfValues()
    {
        var pq = new PriorityQueue<int>(1000);
        ...
        Assert.That(list, Is.EqualTo(Enumerable.Range(1, 1000).Reverse().ToList()));
    }

    [Test]
    public void ToListWithPriority_ShouldReturnListOfItemsWithPriority_SmallNumberOfValues()
    {
        var pq = new PriorityQueue<string>(5);
        pq.Enqueue(1, "item1");
        pq.Enqueue(3, "item3");
        ...
        var list = pq.ToListWithPriority();

        Assert.That(list, Is.EqualTo(new List<(double, string)> { (3, "item3"), (2, "item2"), (1, "item1") }));
    }

    [Test]
    public void ToListWithPriority_ShouldReturnListOfItemsWithPriority_LargeNumberOfValues()
    {
        var pq = new PriorityQueue<int>(1000);
        for (int i = 1000; i > 0; i--)
        {
        ...
        Assert.That(list, Is.EqualTo(Enumerable.Range(1, 1000).Reverse().Select(i => ((double)i, i)).ToList()));
    }

    [Test]
    public void ToArray_ShouldReturnArrayOfItems_SmallNumberOfValues()
    {
        var pq = new PriorityQueue<string>(5);
        pq.Enqueue(1, "item1");
        pq.Enqueue(3, "item3");
        ...
        Assert.That(array, Is.EqualTo(new string[] { "item3", "item2", "item1" }));
    }

    [Test]
    public void ToArray_ShouldReturnArrayOfItems_LargeNumberOfValues()
    {
        var pq = new PriorityQueue<int>(1000);
        for (int i = 1000; i > 0; i--)
        {
        ...
        Assert.That(array, Is.EqualTo(Enumerable.Range(1, 1000).Reverse().ToArray()));
    }

    [Test]
    public void ToArrayWithPriority_ShouldReturnArrayOfItemsWithPriority_SmallNumberOfValues()
    {
        var pq = new PriorityQueue<string>(5);
        pq.Enqueue(1, "item1");
        pq.Enqueue(3, "item3");
        ...
        var array = pq.ToArrayWithPriority();

        Assert.That(array, Is.EqualTo(new (double, string)[] { (3, "item3"), (2, "item2"), (1, "item1") }));
    }

    [Test]
    public void ToArrayWithPriority_ShouldReturnArrayOfItemsWithPriority_LargeNumberOfValues()
    {
        var pq = new PriorityQueue<int>(1000);
        for (int i = 1000; i > 0; i--)
        {
        ...
        Assert.That(array, Is.EqualTo(Enumerable.Range(1, 1000).Reverse().Select(i => ((double)i, i)).ToArray()));
    }
}
