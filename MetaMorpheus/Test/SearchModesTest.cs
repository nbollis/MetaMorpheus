...
namespace Test
{
    ...
    public static class SearchModesTest
    {
        ...
        public static void TestAdductMassDiffAcceptor_AbsoluteTolerance()
        {
            ...
            Assert.That(intervals[0].AllowedInterval.Minimum, Is.EqualTo(1000 - 0.01).Within(1e-8));
            Assert.That(intervals[0].AllowedInterval.Maximum, Is.EqualTo(1000 + 0.01).Within(1e-8));
            Assert.That(intervals[1].AllowedInterval.Minimum, Is.EqualTo(1000 + 21.981943 - 0.01).Within(1e-8));
            Assert.That(intervals[1].AllowedInterval.Maximum, Is.EqualTo(1000 + 21.981943 + 0.01).Within(1e-8));
            ...
            Assert.That(observedIntervals[0].AllowedInterval.Minimum, Is.EqualTo(1100 - 0.01).Within(1e-8));
            Assert.That(observedIntervals[0].AllowedInterval.Maximum, Is.EqualTo(1100 + 0.01).Within(1e-8));
            // Na1: observedMass - 21.981943
            Assert.That(observedIntervals[1].AllowedInterval.Minimum, Is.EqualTo(1100 - 21.981943 - 0.01).Within(1e-8));
            Assert.That(observedIntervals[1].AllowedInterval.Maximum, Is.EqualTo(1100 - 21.981943 + 0.01).Within(1e-8));
            // K2: observedMass - 2*37.955882
            Assert.That(observedIntervals[5].AllowedInterval.Minimum, Is.EqualTo(1100 - (2 * 37.955882 + 21.981943) - 0.01).Within(1e-8));
            Assert.That(observedIntervals[5].AllowedInterval.Maximum, Is.EqualTo(1100 - (2 * 37.955882 + 21.981943) + 0.01).Within(1e-8));
        }
        ...
        public static void TestAdductMassDiffAcceptor_PpmTolerance()
        {
            ...
            Assert.That(intervals[0].AllowedInterval.Contains(1000), Is.True);
            Assert.That(intervals[1].AllowedInterval.Contains(1000 + 21.981943), Is.True);
            ...
            // Unadducted: observedMass - 0
            Assert.That(observedIntervalsPpm[0].AllowedInterval.Contains(1100), Is.True);
            // Na1: observedMass - 21.981943
            Assert.That(observedIntervalsPpm[1].AllowedInterval.Contains(1100 - 21.981943), Is.True);
        }
