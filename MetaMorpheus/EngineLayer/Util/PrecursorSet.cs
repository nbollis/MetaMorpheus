...
public class PrecursorSet : IEnumerable<Precursor>
{
    ...
    public readonly bool PerformFiltering;
    /// <summary>
    ...
    /// </summary>
    /// <param name="tolerance">The tolerance used to determine precursor equivalence.</param>
    /// <param name="performFiltering">Whether to perform filtering during sanitization.</param>
    public PrecursorSet(Tolerance tolerance, bool performFiltering = true)
    {
        Tolerance = tolerance;
