...
namespace TaskLayer
{
    public class MyFileManager
    {
        ...
        public MsDataFile LoadFile(string origDataFile, CommonParameters commonParameters)
        {
            ...
            {
                MyMsDataFiles[origDataFile] = MsDataFileReader.GetDataFile(origDataFile).LoadAllStaticData(filter, commonParameters.MaxThreadsToUsePerFile);
                ...
                //}
                //else if (Path.GetExtension(origDataFile).Equals(".raw", StringComparison.OrdinalIgnoreCase))
                //{
        ...
        public void OpenDynamicDataConnection(string origDataFile)
        {
            MyMsDataFiles[origDataFile].InitiateDynamicConnection();
        }
