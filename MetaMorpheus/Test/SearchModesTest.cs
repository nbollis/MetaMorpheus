...
namespace Test
{
    ...
    public static class SearchModesTest
    {
        ...
        public static void TestDotSearchMode()
        {
            ...
            Assert.That(theList2[0].Minimum, Is.LessThan(1000));
            Assert.That(theList2[0].Maximum, Is.GreaterThan(1000));
            ...
            Assert.That(theList2[1].Minimum, Is.LessThan(1001));
            Assert.That(theList2[1].Maximum, Is.GreaterThan(1001));
        }
