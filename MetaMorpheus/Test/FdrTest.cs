...
namespace Test
{
    ...
    public static class FdrTest
    {
        ...
        public static void FdrTestMethod()
        {
            ...
            IBioPolymerWithSetMods pep1 = digested[0];
            IBioPolymerWithSetMods pep2 = digested[1];
            IBioPolymerWithSetMods pep3 = digested[2];
            IBioPolymerWithSetMods pep4 = digested[3];
