...
public class RnaDatabaseLoadingTests
{
    ...
    public static void TestDbReadingDifferentExtensions(string databaseFileName)
    {
        ...
        bioPolymers = task.LoadBioPolymers("TestTaskId", dbForTask, true, DecoyType.None, [], commonParameters);
    ...
    public static void DbReadingHandleAccessionCollisions(TargetContaminantAmbiguity type, string[] expectedAccessions, bool[] expectedIsContaminant)
    {
        ...
        var bioPolymers = task.LoadBioPolymers("TestTaskId", dbsForTask, true, DecoyType.None, [], commonParameters);
    ...
    public void TwoTruncationsAndSequenceVariant_DbLoading()
    {
        ...
        var rna = task.LoadBioPolymers("TestTaskId", dbsForTask, true, DecoyType.Reverse, localizableModificationTypes, commonParameters);
