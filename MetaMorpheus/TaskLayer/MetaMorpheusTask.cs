...

{
        ...
        protected static void WritePsmsToTsv(IEnumerable<SpectralMatch> psms, string filePath, IReadOnlyDictionary<string, int> modstoWritePruned, MassDiffAcceptor? massDiffAcceptor = null)
        {
