...
namespace Test
{
    ...
    public static class MultiProteaseParsimonyTest
    {
        ...
        public static void MultiProteaseParsimony_IndistringuishableProteinsNowDistinguishable()
        {
            ...
            var pg1pep1 = pg1.AllPeptides.Where(v => v.BaseSequence == "ABC").First();
            var pg1pep2 = pg1.AllPeptides.Where(v => v.BaseSequence == "EFG").First();
            ...
            var pg2pep1 = pg2.AllPeptides.Where(v => v.BaseSequence == "ABC").First();
            var pg2pep2 = pg2.AllPeptides.Where(v => v.BaseSequence == "EFG").First();
