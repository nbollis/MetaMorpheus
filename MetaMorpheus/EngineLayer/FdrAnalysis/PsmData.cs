...
namespace EngineLayer.FdrAnalysis
{
    public class PsmData
    {
        public static readonly IImmutableDictionary<string, string[]> trainingInfos = new Dictionary<string, string[]>
        {
...

            {
                "top-down", new[]
                {
                    ...
                    "UniqueFragmentIonCount", "UniqueTerminalFragmentIonCount"
                }
            },
        ...
        public static readonly IImmutableDictionary<string, int> assumedAttributeDirection = new Dictionary<string, int> {
            ...
            { "InternalIonCount", 1},
            { "UniqueFragmentIonCount", 1},
            { "UniqueTerminalFragmentIonCount", 1},
            }.ToImmutableDictionary();
        ...
        [LoadColumn(29)]
        public float UniqueFragmentIonCount { get; set; }

        [LoadColumn(30)]
        public float UniqueTerminalFragmentIonCount { get; set; }
    }
}